...
final bookingsLocalDataSourceProvider = Provider<BookingsLocalDataSource>((ref) {
  throw UnimplementedError('bookingsLocalDataSourceProvider must be overridden in main.dart');
});
...
final bookingsRepositoryProvider = Provider<BookingsRepository>((ref) {
  return BookingsRepositoryImpl(
    bookingsApi: ref.watch(bookingsApiProvider),
    localDataSource: ref.watch(bookingsLocalDataSourceProvider),
  );
});

final getCachedBookingsUseCaseProvider = Provider<GetCachedBookings>((ref) {
  return GetCachedBookings(ref.watch(bookingsRepositoryProvider));
});
